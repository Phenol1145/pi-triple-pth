 ...
 *
 * 用法：
 *   npx tsx scripts/tools/n28-structure-snapshot.ts
 *   npx tsx scripts/tools/n28-structure-snapshot.ts --check
 *   npx tsx scripts/tools/n28-structure-snapshot.ts --update
 */

import { createHash } from "node:crypto";
import { readFile, readdir, writeFile } from "node:fs/promises";
import path from "node:path";
import { resolveImportTarget } from "../check/pth-boundaries-core.js";
