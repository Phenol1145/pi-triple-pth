 ...
 *
 * 用法（仓库根）：
 *   DATABASE_URL=… npx tsx scripts/tools/n14-p3-tool-promotion.ts            # 真跑（写库）
 *   DATABASE_URL=… npx tsx scripts/tools/n14-p3-tool-promotion.ts --dry-run  # 只验证不写库
 *   DATABASE_URL=… npx tsx scripts/tools/n14-p3-tool-promotion.ts --candidate fn-wx7wk7
 *
