/**
 * scripts/accept/accept-n29-minimal-intake.ts —— N29 最小可信摄入内环唯一验收权威（计划 §5 Task 7）。
 *
...
} from "../eval/eval-n29-minimal-intake.js";
 ...
 * `scripts/tools/n29-canary-gpe-wikipedia.ts` 在真实公网来源上产出并绑定当时的 evaluatedCommit。
