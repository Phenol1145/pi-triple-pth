 ...
 *   docker cp scripts/seed/seed-wiki.ts pi-platform-pi-platform-1:/app/scripts/seed/seed-wiki.ts
 *   docker cp docs/pth/concepts.md pi-platform-pi-platform-1:/app/scripts/concepts-seed.md
 *   docker exec pi-platform-pi-platform-1 node --experimental-strip-types /app/scripts/seed/seed-wiki.ts /app/scripts/concepts-seed.md
 */
  ...
  try {
    ...
    await pool.query(
      ...
      [
        ...
        t.content,
        JSON.stringify({ seededAt: Date.now(), source: "concepts.md §2 唯一词表", seeder: "scripts/seed/seed-wiki.ts" }),
      ],
    );
    written++;
  } catch (e) {
