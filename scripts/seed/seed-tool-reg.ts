 ...
 *   DATABASE_URL=… npx tsx scripts/seed/seed-tool-reg.ts            # 落库
 *   DATABASE_URL=… npx tsx scripts/seed/seed-tool-reg.ts --check    # 只体检：DB ≡ 生成集？
 * 容器内（compose 网络——seed-wiki 同款）：
 *   docker cp scripts/seed/seed-tool-reg.ts pi-platform-pi-platform-1:/app/scripts/
 *   docker exec pi-platform-pi-platform-1 npx tsx /app/scripts/seed/seed-tool-reg.ts
 */
