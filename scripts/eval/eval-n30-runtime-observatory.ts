/**
 * scripts/eval/eval-n30-runtime-observatory.ts —— N30 运行观测台 provisional evaluator（纯判据 + 开发期自查 CLI）。
 *
 ...
 *
 * 唯一权威验收结论由 `scripts/accept/accept-n30-runtime-observatory.ts` 给出。
 */
