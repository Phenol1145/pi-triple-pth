#!/usr/bin/env tsx
/**
 * scripts/pth-bench-dev-family.ts —— developer 族工作能力评估套件（2026-08-25）。
 *
 ...
 *
 * 用法（三条角色道并行）：
 *   PTH_TOKEN=... npx tsx scripts/pth-bench-dev-family.ts developer > /tmp/bench-developer.json
 *   PTH_TOKEN=... npx tsx scripts/pth-bench-dev-family.ts coder > /tmp/bench-coder.json
 *   PTH_TOKEN=... npx tsx scripts/pth-bench-dev-family.ts tester > /tmp/bench-tester.json
 */
