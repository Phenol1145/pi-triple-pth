/**
 * kernel/storage/knowledge-intake-pg-repository.ts — N29 Task 3：知识摄入内环的 PG 真相源仓库实现。
 *
 * 2026-08-24 非破坏性拆分：从 `knowledge-intake-pg.ts` 移出 `PgKnowledgeIntakeRepository` 类、
 * 事务绑定写入面与工厂；原文件保留为 barrel 再导出。
 */
