...
> 上位设计：[N26 自主知识摄入设计](./n26-autonomous-knowledge-intake-design.md)
...
**Spec:** [docs/pth/n26-autonomous-knowledge-intake-design.md](./n26-autonomous-knowledge-intake-design.md)
...
- Create: `docs/pth/n29-minimal-intake-report.md`
...
```bash
git add docs/pth/n29-minimal-intake-acceptance.json docs/pth/n29-minimal-intake-report.md docs/README.md CONTEXT.md
