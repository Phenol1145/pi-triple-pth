...
| 5 | **PTH Bench 统一抽象** | `docs/pth/design/pth-bench-unified-design.md` | W0–W4 完成 + HttpBenchDriver 落地（2026-08-24） | agentic benchmark 与运行效率测试统一流水线（Scenario/Driver/ExecPolicy/Grader/Baseline Gate） | 核心/runner/gate/ScriptedLlmFn/matrix/HttpBenchDriver 已落地；CLI 薄壳待续 |
