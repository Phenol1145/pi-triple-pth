...
| 5 | **PTH Bench 统一抽象** | `docs/pth/design/pth-bench-unified-design.md` | W0–W4 完成（2026-08-24） | agentic benchmark 与运行效率测试统一流水线（Scenario/Driver/ExecPolicy/Grader/Baseline Gate） | 核心/runner/gate/ScriptedLlmFn/matrix 已落地；HttpBenchTarget/CLI 待续 |
