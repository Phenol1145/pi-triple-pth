...
| 5 | **PTH Bench 统一抽象** | `docs/pth/design/pth-bench-unified-design.md` | W0 核心完成（2026-08-24）；W1–W4 进行中 | agentic benchmark 与运行效率测试统一流水线（Scenario/Driver/ExecPolicy/Grader/Baseline Gate） | 核心类型/grader/report 已落地；driver/CLI/baseline/L0 待续 |
...
5. **PTH Bench**：依赖 TCE/观察策略，作为 A/B 周期的受控测量装置。W0 核心已完成（2026-08-24），W1–W4 进行中。
