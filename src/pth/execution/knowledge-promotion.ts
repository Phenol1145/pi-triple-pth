 ...
 *
 * 本文件只保留服务编排；PG 仓库访问（createPgKnowledgeVerificationRepo、行映射、
 * KnowledgeVerificationRepo 窄端口）已抽到 knowledge-promotion-repo.ts。
 *
 * R3/P0-3 + P1-2：
...
import { planFromRow, type KnowledgeVerificationRepo, type KnowledgeVerificationQueryable } from "./knowledge-promotion-repo.js";
export { createPgKnowledgeVerificationRepo, type KnowledgeVerificationRepo, type KnowledgeVerificationQueryable } from "./knowledge-promotion-repo.js";
