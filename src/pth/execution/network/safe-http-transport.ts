/**
 * execution/network/safe-http-transport.ts — 受限只读 HTTP(S) 安全传输（TCE 网络 V1 Wave 2）。
 *
 * 安全传输 ownership 已从 kernel 路径迁移到 Execute 公共底座；`impls/kernels/web-transport.ts`
 * 保留旧 import barrel 兼容。
 *
